      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.summaryContainer}>
            <View style={styles.summaryRow}>
              ...
              {!bill.notes && <View style={{ width: '55%' }} />}
              ...
              <View style={styles.amountWordsRow}>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.amountWordsText}>
                    Dirhams {numberToWords(grandTotal)} Only
                  </Text>
                </View>
              </View>
            </View>
              ...
              <View style={styles.validityBox}>
                ...
                <View style={styles.validityItem}>
                  ...
                  <Text style={styles.boxContent}>
                    This quotation is valid for 30 days from the date mentioned above
                  </Text>
                </View>
                <View style={styles.validityItem}>
                  <Text style={styles.bulletPoint}>•</Text>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.systemNote}>
            This is a system-generated quotation and is valid without signature
          </Text>
          <Text style={styles.footerText}>
