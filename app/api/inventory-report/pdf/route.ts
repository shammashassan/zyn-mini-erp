...
import { InventoryReportDocument } from '@/components/pdf/InventoryReportDocument';
...
export async function GET(request: NextRequest) {
    try {
        ...
        const dataRes = await fetch(
            `${origin}/api/inventory-report?startDate=${startDate}&endDate=${endDate}`,
        ...
        const pdfStream = await renderToStream(
            React.createElement(InventoryReportDocument, {
