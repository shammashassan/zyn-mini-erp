...
import { TaxReportDocument } from '@/components/pdf/TaxReportDocument';
...
export async function GET(request: NextRequest) {
    try {
        ...
        const dataRes = await fetch(
            `${origin}/api/tax-report?startDate=${startDate}&endDate=${endDate}`,
        ...
        const pdfStream = await renderToStream(
            React.createElement(TaxReportDocument, {
        ...
        return new NextResponse(pdfStream as any, {
            ...
            headers: {
                ...
                'Content-Disposition': `inline; filename="Tax_Report.pdf"`,
            },
        });
    } catch (error: any) {
