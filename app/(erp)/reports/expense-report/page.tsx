...
import { exportExpenseReportToExcel } from "@/utils/reportExports";
...
function ExpenseReportPageContent() {
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/expense-report/pdf?${params}`);
  ...
  const handleExportExcel = () => {
    ...
    setIsExporting(true);
    try {
      exportExpenseReportToExcel(data.monthlyBreakdown, data.summary, { from: dateRange!.from!, to: dateRange!.to! }, null);
              ...
              <div className="flex items-center gap-3 self-start lg:self-center">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Expense summary from approved expenses.
                  </p>
                </div>
              </div>
