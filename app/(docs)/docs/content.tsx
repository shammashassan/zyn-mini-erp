...
import RolesPermissionsSection from "@/components/docs/sections/roles-permissions";
import ProductsSection from "@/components/docs/sections/products";
import MaterialsSection from "@/components/docs/sections/materials";
import StockAdjustmentSection from "@/components/docs/sections/stock-adjustment";
import PartiesSection from "@/components/docs/sections/parties";
import ContactsSection from "@/components/docs/sections/contacts";
import PayeesSection from "@/components/docs/sections/payees";
import InvoicesSection from "@/components/docs/sections/invoices";
import ReceiptsSection from "@/components/docs/sections/receipts";
import DeliveryNotesSection from "@/components/docs/sections/delivery-notes";
import SalesReturnsSection from "@/components/docs/sections/sales-returns";
import DebitNotesSection from "@/components/docs/sections/debit-notes";
import PurchasesSection from "@/components/docs/sections/purchases";
import ExpensesSection from "@/components/docs/sections/expenses";
import PaymentsSection from "@/components/docs/sections/payments";
import PurchaseReturnsSection from "@/components/docs/sections/purchase-returns";
import CreditNotesSection from "@/components/docs/sections/credit-notes";
import ReportsSection from "@/components/docs/sections/reports";
import ChartOfAccountsSection from "@/components/docs/sections/chart-of-accounts";
import JournalSection from "@/components/docs/sections/journal";
import FinancialStatementsSection from "@/components/docs/sections/financial-statements";
import EmployeesSection from "@/components/docs/sections/employees";
import UserManagementSection from "@/components/docs/sections/user-management";
