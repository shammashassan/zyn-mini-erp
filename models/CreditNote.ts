// models/CreditNote.ts - FINAL: Using Party/Contact snapshots, no legacy fields
...
CreditNoteSchema.index({ partyId: 1, creditDate: -1 });
CreditNoteSchema.index({ 'partySnapshot.displayName': 'text' });
